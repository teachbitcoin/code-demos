// Compile with:
// g++ -std=c++11 `pkg-config --cflags libbitcoin libbitcoin-network --libs libbitcoin libbitcoin-network` -o channel_subscription_getblock_example channel_subscription_getblock_example.cpp
...
int bc::main(int argc, char* argv[])
{
        ...
        bc::message::block::const_ptr block)
    {
        ...
        // ---------------------------------------------------------------------
        // Derive required txid, witness root, witness data here.
        // ---------------------------------------------------------------------     
